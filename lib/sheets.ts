...
export async function fetchDashboardData(): Promise<DashboardData> {
  ...
  for (let i = dataStart; i < rows.length; i++) {
    ...
    // Col map (0-indexed): 0=STT,1=Ngày,2=NVTD,3=Nguồn,4=HinhThuc,5=GioiThieu,
    // 6=CapBac,7=ViTri,8=TenUV,9=empty,10=SDT,11=Email,12=Link,
    // 13=DinhHuongTeam,14=Team,15=HRlocCV,16=LeaderLocCV,17=KetQuaGoiMoi,
    // 18=NgayXuLy,19=GuiMail,20=NgayPV,21=ThamGiaPV,22=KetQuaPV,
    // 23=GuiMailKQ,24=DongYDiLam,25=NgayHen,26=NhanViec,27=DiLam10Ngay
